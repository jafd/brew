...
HOMEBREW_DEFAULT_PREFIX = ENV.fetch("HOMEBREW_DEFAULT_PREFIX", "/usr/local")
HOMEBREW_DEFAULT_REPOSITORY = "#{HOMEBREW_DEFAULT_PREFIX}/Homebrew"
HOMEBREW_MACOS_ARM_DEFAULT_PREFIX = ENV.fetch("HOMEBREW_DEFAULT_PREFIX", "/opt/homebrew")
HOMEBREW_MACOS_ARM_DEFAULT_REPOSITORY = HOMEBREW_MACOS_ARM_DEFAULT_PREFIX
HOMEBREW_LINUX_DEFAULT_PREFIX = ENV.fetch("HOMEBREW_DEFAULT_PREFIX", "/home/linuxbrew/.linuxbrew")
